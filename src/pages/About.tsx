  ...
  return (
    <>
      <Seo
        ...
        description="Atlas Offroad ATV was founded by riders, for riders. Discover our mission to deliver premium offroad machines with concierge service."
        path="/about"
      />
      ...
      <section className="container py-20 grid md:grid-cols-2 gap-16 max-w-5xl">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          ...
          <p className="mt-4 text-muted-foreground leading-relaxed">
            Atlas Offroad ATV exists for the riders who refuse to follow the road. We curate only the machines we'd ride ourselves —
            then deliver them with the kind of obsessive care most dealerships forgot. Every quad, every side-by-side, every detail.
          </p>
        </motion.div>
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}>
          <h2 className="font-display text-3xl tracking-wider text-gradient">Vision</h2>
          <p className="mt-4 text-muted-foreground leading-relaxed">
            To redefine what premium offroad ownership feels like — from the moment you browse to the moment you carve a new trail.
            We're building the most trusted name in ATV sales, one rider at a time.
          </p>
        </motion.div>
      </section>
      ...
      <section className="container py-20">
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            { n: "50 states", l: "Delivery network" },
          ].map((s, i) => (
